...
\addcontentsline{toc}{part}{Prólogo}
...
a ser oficialmente contatada pela Fundação Nacional do Índio (\versal{FUNAI}),
...
%manter essa referência no meio do texto?
 situam"-se nas Terras Indígenas (\versal{TI}) Carú e Awá, e uma
distância de 150 km separa as pessoas da \versal{TI} Carú e Awá, embora estas áreas
...
contatos. Um dos chamarizes para os homens que auxiliavam a \versal{FUNAI} era a
...
trabalho de doutorado na Universidade de São Paulo (\versal{USP}). Nesta época
...
decorrer da ferrovia que se espalha ao longo da \versal{TI} Caru; a chegada cada
vez mais frequente de criadores de gado, madeireiros e pequenos
caçadores para perto dos acessos da \versal{TI}, o que faz as pessoas se
...
forma colaborativa com organizações como a \versal{ONG} inglesa Survival
International e, de maneira mais pontual, com o Conselho Indigenista
Missionário (\versal{CIMI}) e a \versal{ONG} ambientalista Greenpeace. A própria
Coordenação Geral de Índios Isolados e Recém"-Contatados (\versal{CGIIRC}) da
\versal{FUNAI}, pela urgência da situação, me convidou junto com a colega e
linguista Marina Magalhães (docente do departamento de linguística da
\versal{U}n\versal{B} e estudiosa da língua Guajá) para facilitarmos junto às comunidades
...
\versal{TI} Awá durante o primeiro semestre de 2014. Neste momento está em curso
...
No \versal{capítulo} 1, apresento a história recente permeada pelos
...
O \versal{capítulo} 2 se dedica às formas de relação no espaço e como os
...
No \versal{capítulo} 3, faço uma descrição dos componentes que marcam a
...
No \versal{capítulo} 4, mostro as chamadas \emph{relações de alteridade}
...
O \versal{capítulo} 5 faz uma descrição do sistema de aliança, com
...
No \versal{capítulo} 6, articulo a ideia de \emph{riku} com outras relações homólogas, mas que não seriam
...
Os \versal{capítulos} 7 e 8 são uma descrição das atividades de caça
...
No \versal{capítulo} 9, esboço a relação dos Guajá com os
...
incidente que envolveu os Guajajara e a \versal{FUNAI}, por isso retornei à
...
muitas vezes, depender de caronas da \versal{FUNAI} e \versal{SESAI}. Apesar de ter
