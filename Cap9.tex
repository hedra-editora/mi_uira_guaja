...
ficam na Terra. Minha pele torna"-se \emph{ajỹ}. Meu coração, minha alma e minha carne vão
para o céu. Ficam vivas. Ficam no céu, tornam"-se \emph{karawara}. Ficam cantando,
dançando, transformados em \emph{karawara}. As penas brancas e as vermelhas (que adornam os \emph{karawara}) ficam no céu.}{\textsc{irakatakoa}, aldeia Awá, 2006\footnotemark}

\footnotetext{\emph{Amanõ xi, ikwẽ ha pirera
  wype, ha pyporera wype. Ha pirera iko ajỹ neme. Ha ja'ajna, ha ritekera, ha'okera oho
  iwape. Ikwẽ. Iku iwape, iku karawa neme. Jã ika, panỹ ika, oho karawa neme. Hawiju, japakwa iku iwape}. Coletado e traduzido por Marina Magalhães, 2006.}
...
\paragraph{A traição dos xerimbabos}
...
\textsc{funai}, comer arroz e farinha. O fato de eles morarem em aldeias, e não
...
\textsc{karawara}: \emph{Oho \emph{jawaramỹna} pyry!}

\textsc{guajá}: \emph{Oho \emph{karai} pyry!}

\textsc{português}: \emph{Foram para perto dos \emph{brancos}!}
\end{quote}
...
\textbf{Português}                                                      & \textbf{Guajá}                                                      & \textit{\textbf{Karawara}}                                                                         \\ \hline
...
queixada                                                                & \begin{tabular}[c]{@{}l@{}}\emph{xohoa} ou\\ \emph{xahua}\end{tabular}            & \begin{tabular}[c]{@{}l@{}}\emph{ma'amijamõmuxiri} - \\ ``caça que grunhe e\\ bate o dente''\end{tabular} \\ \hline
\begin{tabular}[c]{@{}l@{}}não indígena\\ (brancos)\end{tabular}        & \textit{karaia}                                                     & \begin{tabular}[c]{@{}l@{}}\emph{jawarymỹ} - \\ ``cachorro morto''\end{tabular}                                                                                  \\ \hline
...
\begin{tabular}[c]{@{}l@{}}madeira/pau/\\ tronco de árvore\end{tabular} & \textit{ira}                                                        & \begin{tabular}[c]{@{}l@{}}\emph{iraramãja} - \\ ``árvore grande''\end{tabular}                           \\ \hline
...
\begin{tabular}{|l|l|l|}
\hline
\begin{tabular}[c]{@{}l@{}}diversos pássaros\\ como jacamim,\\ jacu, inhambu,\\ mutum, dentre\\ outros\end{tabular} & diversos           & \begin{tabular}[c]{@{}l@{}}\emph{irapapoa} - ``pássaro\\ de assa''\end{tabular}                                                                                                                                                 \\ \hline
...
macaco capelão                                                                                                      & \textit{waria}     & \begin{tabular}[c]{@{}l@{}}\emph{tawamỹna} - ``o faleci-\\ do flecha reta''\\ \emph{irarawyxa'amỹna} - \\ ``sangue na flecha''\\ \emph{irarawaxa'amỹna} - ``o\\ que mora na árvore''\end{tabular}                                             \\ \hline
cuxiú-preto                                                                                                         & \textit{kwixua}    & \begin{tabular}[c]{@{}l@{}}\emph{ma'amijarawỹjamata} - \\ ``caça que parece \\ barbuda''\\ \emph{ma'amijajamata} - ``ca-\\ ça barbuda''\end{tabular}                                                                                   \\ \hline
meu território                                                                                                      & \textit{harakwaha} & \textit{hapunua}                                                                                                                                                                                                         \\ \hline
tatu                                                                                                                & \textit{tatua}     & \begin{tabular}[c]{@{}l@{}}\emph{ma'amijawykwahara} - \\ ``caça que é do buraco\\ do chão''\\ \emph{ma'amijawykwajaxa'a-}\\ \emph{mỹna} - ``caça que é dona\\ do buraco do chão''\\ \emph{ma'amijajamekera} - \\ ``caça que tem casco''\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
jaboti       & \textit{hamixa}      & \begin{tabular}[c]{@{}l@{}}\emph{ma'amijajape} - ``caça\\ com casco''\end{tabular}                                   \\ \hline
...
caçador, por exemplo de tatus como \emph{Maniõxa'a} (``gente
...
\section{\emph{Takwarihuxa'a} (gente taquara)}
...
\begin{itemize}
\item
  \emph{\textsc{makaro jawyxa'a}} (ou simplesmente
  \emph{\textsc{makaroa}}) -- ``gente pomba"-galega''. Trata"-se de uma
...
\item
  \emph{\textsc{takwa jara}} -- ``gente taquara''. É um comedor de antas.
  ...
  com a humanidade.
\item
  \emph{\textsc{pu'uwa jara}} -- ``gente pássaro"-carretão''.
...
\item
  \emph{\textsc{takwariroxa'a}} -- ``gente folha da taquara''. Além de
  ...
  \emph{takwari ruy}.
\item
  \textsc{\emph{japu jara}} -- ``gente japu''. Como vimos no mito
...
\item
  \emph{\textsc{majhu jara}} -- ``gente jiboia''. Trata"-se da
...
\item
  \emph{\textsc{kaapapanyxa'a}} -- ``gente marimbondo"-caba''. Um grande
...
\item
  \textsc{\emph{maniõxa'a}} -- ``gente pássaro"-\emph{makaripy}''. É um
  ...
  identificar.
\item
  \textsc{\emph{kamarajuxu'a}} -- ``gente \emph{kamara}''. São versões
...
\item
  \emph{\textsc{amara'yxa'a}} -- ``gente chuva'' ou simplesmente ``dono da
  chuva''. Quando esse \emph{karawara} canta no céu, a chuva cai na
  Terra.
\item
  \emph{\textsc{axu jara}} -- ``gente pássaro"-alma"-de"-gato''. É um
...
\item
  \emph{\textsc{kaxa'y}} -- ``gente pássaro"-estalador"-do"-norte'',
...
\item
  \emph{\textsc{warajuxa'a}} -- ``gente borboleta''. Um \emph{karawara}
...
\item
  \emph{\textsc{waraju}} -- ``gente borboleta''. Diferente de
...
\item
  \emph{\textsc{pinawãxa'a}} -- ``gente bacaba''. São
  caçadores/comedores de capelães.
\item
  \emph{\textsc{jaharoxa'a}} -- ``gente jussara/açaí''. Caçam e se
  alimentam de saguis.
\item
  \emph{\textsc{jakare jara}} -- ``gente"-jacaré''. Caçadores/comedores
  de paca.
\item
  \emph{\textsc{puku jara}} -- ``gente pomba"-trocal''. É um
  ...
  speciosa}).
\item
  \emph{\textsc{marajuxa'a}} -- ``gente fruto"-da"-palmeira"-marajá''. São
  ...
  (\emph{Bactris maraja}).
\item
  \emph{\textsc{juxa'a}} -- ``gente espinho"-da"-palmeira"-marajá''. São
  caçadores de capelão. Seu \emph{nima} na Terra são os espinhos do
  marajazeiro (\emph{Bactris maraja}).
\item
  \emph{\textsc{inamẽxa'a}} -- ``gente anambé''. Um caçador de tucanos. Esse \emph{karawara}
...
\item
  \emph{\textsc{inamẽ papa'ỹ̃}} -- ``gente"-pássaro"-caneleiro"-preto''. São
  ...
  polychopterus}).
\item
  \emph{\textsc{tapa'y}} --``gente formiga"-correição''. São caçadores de
...
\item
  \textsc{\emph{araturaxa'a}} --``gente corujinha"-do"-mato''. Seu duplo
  na Terra é a coruja \emph{arakwari'ia}, corujinha"-do"-mato
  (\emph{Megascops choliba}).
\item
  \emph{\textsc{kapitỹ jara}} -- ``gente gavião"-de"-cauda"-curta''. É um
  ...
  brachyurus}).
\item
  \emph{\textsc{xakara jara}} -- ``gente gavião"-caracoleiro'' e ``gente
...
\item
  \emph{\textsc{panỹxa'a}} -- ``gente"-borboleta"-azul''. É um caçador de
  queixadas.
\item
  \emph{\textsc{jawataraxa'a}} -- ``gente"-lontra'' (``gente ariranha'').
...
\item
  \emph{\textsc{makaratỹ jara}} --``gente pica"-pau'' (dos gênero
  ...
  \emph{pica"-pau}.
\item
  \textsc{\emph{arira jara}} -- ``gente morcego''. Caçadores de
  caititus. Seus \emph{nima} terrenos são os \emph{morcegos}
  \emph{arira}.
\item
  \emph{\textsc{manaky jara}} -- ``gente poraquê''. É um \emph{karawara}
...
\item
  \emph{\textsc{pira jara}} -- ``gente araçari''. É um caçador de
...
\item
  \emph{\textsc{katexa'a}} -- ``gente uru"-corcovado''. Seu duplo terreno
  é o uru"-corcovado (\emph{Odontophorus gujanensis}), chamado
  \emph{urua} na língua Guajá.
\item
  \emph{\textsc{watarawyxa'a}} -- ``gente palha"-do"-babaçu''. São
  caçadores de porcos queixadas, e seus duplos terrenos são a
  palha/folha da palmeira babaçu (\emph{Orbignya phalerata}).
\item
  \textsc{\emph{kamixa tuwira}} -- ``gente jaboti''. \emph{Karawara} caçador de capelão.
  Seu \emph{nima} terreno é o \emph{jaboti}, \emph{kamixa}.
\item
  \emph{\textsc{jaxajhu jara}} -- ``gente capininga''. Tal como o \emph{karawara} ``jaboti''
...
\item
  \textsc{\emph{pakwa'ĩ jara}} -- ``gente (pássaro) rolinha''. \emph{Karawara} caçador de
  capelães. Seu duplo terreno é o pássaro \emph{Pakwa'ĩa} (um tipo de
  \emph{rolinha}).
\item
  \textsc{\emph{jurixu jara}} -- ``gente juriti''. Um caçador de capelães. Seu duplo
...
\item
  \emph{\textsc{kiripixa'a}} -- ``gente ubim'' (a palmeira \emph{Geonoma deversa}). É um caçador de saguis
...
\item
  \emph{\textsc{amỹ kiripi}} -- literalmente \emph{mamãe kiripi}
  (o \emph{karawara} acima), ela se alimenta de jabotis que outros
  \emph{karawara} lhe fornecem.
\item
  \emph{\textsc{wy'y pokaxa'a}} -- um \emph{karawara} caçador de saguis
  (\emph{atamari'ia}). Seu \emph{nima} terreno é um tipo de
  \emph{taquara (wy'y)} mais fininha.
\item
  \emph{\textsc{amỹxa'a pinihỹ̃}} -- trata"-se de uma mulher que tem
...
\item
  \emph{\textsc{kirimixixa'a}} -- um marimbondo que não pica. Esse
...
\item
  \emph{\textsc{hajra jara}} -- ``gente papa-mel''. Trata"-se de uma versão celeste do animal
  chamado \emph{hajrara} (papa"-mel). Este \emph{karawara} desce à Terra
  para coletar grandes quantidades de mel.
\item
  \emph{\textsc{jua'i jara}} -- um \emph{karawara} cujo duplo terreno é
  um sapo chamado \emph{jua'ia}.
\item
  \emph{\textsc{wara kakyjỹ̃}} -- um \emph{karawara} cujo duplo também é
  um sapo.
\item
  \emph{\textsc{kara pyrana'i}} -- ``gente cará''. Ao lado da macaxeira, é o único
...
\item
  \emph{\textsc{makaxixa'a}} -- ``gente macaxeira''. Um \emph{karawara} caçador de porcos. Seu
  \emph{nima} terreno é a \emph{macaxeira} (\emph{makaxia}).
\item
  \emph{\textsc{jjrahyxa'a}} -- é um caçador de capelães. Esse
  \emph{karawara} não tem nenhum correspondente terreno; só existe no
  \emph{iwa}.
\item
  \emph{\textsc{takwari pinuhũxa'a}} -- um \emph{karawara} caçador de
  antas. Seu \emph{nima} terreno é um tipo de \emph{taquara} escura.
\item
  \emph{\textsc{wy'yrara}} -- um caçador de veados. Seu \emph{nima}
  terreno é um tipo de \emph{taquara} (\emph{wy'ya}).
\item
  \emph{\textsc{takwari}} -- um \emph{karawara} caçador de antas. Seu
  \emph{nima} terreno é um tipo de taboquinha (finos bambus).
\item
  \emph{\textsc{jawajuxa'a}} -- ``gente"-raposa''. Um caçador de cotias e
  quatis. Seu \emph{nima} terreno é a
  \emph{raposa/cachorro"-do"-mato}(\emph{Cerdocyon
  thous}), chamada \emph{jawajua}.
\item
  \emph{\textsc{waha jara}} -- ``gente carangueijo"-do"-rio''. Um \emph{karawara} caçador de veados. Seu
  \emph{nima} terreno é o \emph{carangueijo"-do"-rio} (\emph{waha}).
\item
  \emph{\textsc{irapa jara}} -- ``gente pau d’arco''. É uma espécie de ``dono do arco'' celeste.
...
\item
  \emph{\textsc{pany'ĩa}} -- ``gente borboleta''. Um \emph{karawara} caçador de porcos. Seu
  \emph{nima} é uma \emph{borboleta} chamada \emph{paramuhua}.
\item
  \emph{\textsc{kiripo jara}} -- um caçador de jabutis. Não consegui
  identificar seu \emph{nima} terreno.
\item
  \textsc{\emph{hako jara}} -- ``gente socó''. Um \emph{karawara} pescador, que só se
...
\item
  \textsc{\emph{akyry jara}} -- ``gente maçariquinho''. Um caçador de antas. Seu \emph{nima} na
  Terra é uma espécie de maçarico chamado \emph{akyry,}
  Batuíra"-de"-coleira (\emph{Charadrius collaris}).
\item
  \emph{\textsc{imykyriama jara}} -- ``gente gaivota''. Um \emph{karawara} que só vem à
  ...
  conhecem.
\item
  \emph{\textsc{uru jara}} -- uma espécie de ``dono dos urubus''. De
  ...
  e buscar água.
\item
  \emph{\textsc{y'irara}} -- \emph{karawara} caçador de veados (não
  consegui identificar seu \emph{nima}).
\item
  \emph{\textsc{wiwi jara}} -- ``gente tiriba''. Um caçador de saguis. Seu \emph{nima}
  terreno é o pássaro \emph{wiwia} (\emph{tiriba"-de"-hellmayr},
  \emph{Pyrrhura amazonum}).
\item
  \emph{\textsc{mixiraka'ĩ̃}} -- ``gente inhambu-preto''. Um caçador de veados. Seu \emph{nima} na
  Terra é o pássaro \emph{mixiraka'ĩa} (\emph{inhambú"-preto},
  \emph{Crypturellus} \emph{cinereus}).
\item
  \emph{\textsc{manimy jara}} -- ``gente beija-flor''. Esse \emph{karawara} tem porcos como
  seus animais de criação no \emph{iwa}. Seu \emph{nima} terreno é um
  tipo de \emph{beija"-flor} chamado \emph{manimya}.
\item
  \emph{\textsc{hakura jara}} -- ``gente bacurau''. Um \emph{karawara} caçador de porcos. Seu
  \emph{nima} é o pássaro \emph{hakura}, \emph{bacurau}
  (\emph{Nyctidromus albicollis}).
\item
  \emph{\textsc{hakawỹ jara}} -- ``gente acauã''. Um \emph{karawara} que caça cobras para
  se alimentar. Seu \emph{nima} na Terra é o pássaro \emph{hakawỹa},
  \emph{acauã} (\emph{Herpetotheres cachinnans}).
\item
  \emph{\textsc{haximixa'a}} -- ``gente lagarto/calango''. São caçadores
  de onça pintada (\emph{jawaruhua}).
\item
  \emph{\textsc{jaritea uru}} -- ``gente urubu-rei''. Um \emph{karawara} que nunca desce à
  Terra. Seu \emph{nima} é o \emph{urubu"-rei} (\emph{Sarcoramphus
  papa}).
\item
  \emph{\textsc{merowỹ̃}} -- ``gente mosca''. Um caçador de macacos"-pregos, preguiças e
  papa"-mel. Seu \emph{nima} terreno são várias \emph{moscas},
  \emph{merua}.
\item
  \emph{\textsc{takawari pini}} -- ``gente taquara''. Um \emph{karawara} temido pelos
  \emph{tapỹna} do céu. Seu \emph{nima} é um tipo de taquara.
\item
  \emph{\textsc{pananỹnawhy jara}} -- ``gente (pássaro) Martim-Pescador''. Um \emph{karawara} pescador.
  Alimenta"-se de peixes. Seu \emph{nimá} é o pássaro
  \emph{pananỹnawhya}, \emph{martinho} (\emph{Chloroceryle
  americana}).
\item
  \textsc{\emph{arapijỹ jara}} -- ``gente (pássaro) ariramba''. Um \emph{karawara} cujo
  \emph{nima} é o pássaro \emph{arapijỹa}
  (\emph{ariramba"-de"-cauda"-ruiva}, \emph{Galbula ruficauda}).
\item
  \textsc{\emph{takanihĩ jara}} -- ``gente araçari''. \emph{Karawara} que desce à Terra para
...
\item
  \textsc{\emph{jamukuni jara}} -- ``gente gavião''. Um caçador de nhambus e
  macacos"-pregos. Seu \emph{nima} é um tipo de \emph{gavião} chamado
  \emph{jamukunia} (que não consegui identificar).
\item
  \emph{\textsc{makarai}} -- trata"-se de um \emph{karawara} próximo aos
...
\item
  \emph{\textsc{jurỹxa'a}}. Seu duplo terreno é uma \emph{madeira espinhosa}. É
...
\begin{itemize}
\item
  \emph{\textsc{araku jara}} -- ``gente saracura''. \emph{Karawara} caçador de porcos. Vive
...
\item
  \textsc{\emph{ararakỹ jara}} -- ``gente araracanga''. Um \emph{karawara} que se
  alimenta exclusivamente de pequi. Seu \emph{nima} é a arara
  \emph{ararakỹa}, araracanga (\emph{Ara macao}).
\item
  \emph{\textsc{jawa ka'apara}} -- ``gente onça''. É um \emph{karawara} onça
...
\item
  \emph{\textsc{jawaruhu jara}} -- outro \emph{karawara"-onça}, cujo nome
...
\item
  \emph{\textsc{tapi'i jara}} -- ``gente anta''. Trata"-se de um dos
...
\item
  \emph{\textsc{tamanawã jara}} -- ``gente tamanduá"-bandeira''. Um \emph{karawara} que nunca desce à
...
ser alcançados. Os \emph{karawara} são: \emph{\textsc{arapaha jara}
(veado)}, \emph{\textsc{akwixi jara} (cotia)}, \emph{\textsc{wari jara}
(capelão)} e \emph{\textsc{ka'i jara} (macaco"-prego)}. Se esses seres
...
\begin{itemize}
\item
  \emph{\textsc{pira'ixa'á}} -- ``gente peixe''. Caçadores de cotias,
  tucanos e inhambus. Têm macacos, cotias e quatis como animais de
  criação.
\item
  \emph{\textsc{'y jara}} -- pode ser traduzido como ``dono das águas'' ou
...
\begin{itemize}
\item
  \emph{\textsc{makapiraxa'a}} -- um \emph{karawara} caçador de porcos
  (os caça com tabocas). Não consegui identificar seu \emph{nima}
  terreno.
 \item
  \emph{\textsc{maniapyxa'a}} -- tem como animais de criação no patamar
  celeste os macacos"-pregos.
  \item
  \emph{\textsc{jamukune jara}} -- não caça na Terra, mas se alimenta de
  macacos"-pregos e nhambus.
  \item
  \textsc{\emph{xiwakwakwỹ jara}} -- um \emph{karawara} caçador de
  capelães.
 \item
  \textsc{\emph{tawatoi' jara}} -- um karawara cujo duplo terreno
  é o gavião \emph{Tawato'ia} chamado falcão"-caburé (\emph{Micrastur
  ruficollis}).
  \item
  \emph{\textsc{ma'arawy}} -- caçador comedor de cuxiús.
  \item
  \textsc{\emph{marewa'yxa'a}} -- caçadores de macacos.
  \item
  \textsc{\emph{xakokõj jara}} -- é um caçador/comedor de
  macacos"-pregos.
  \item
  \emph{\textsc{hararamukuxa'a}} -- um \emph{karawara} que pega penas de
  urubu.
  \item
  \emph{\textsc{awihixa'a}} -- as pessoas disseram desconhecer qual é o
...
\begin{itemize}
\item
\emph{\textsc{maira}} -- Dispensa maiores comentários, o demiurgo vive no
...
\item
\emph{\textsc{tapỹna}} -- há dois tipos de \emph{tapỹna}. Um
...
\emph{karawara}.
\item
\emph{\textsc{awy jara}} -- é uma espécie de raposa celeste de cor
...
é agressivo\footnote{ver: http://www.wikiaves.com.br/suiriri. Acesso em 2015.}. Não à toa, o
...
Parafraseando Viveiros de Castro (\emph{op. cit.}, p. 530) em relação aos
...
Eu tenho raiva dos \emph{karai} (não indígenas)\\
...
casado com Panaxĩa, filha (\textsc{zd}) de sua irmã Amỹ Pirahỹa (\textsc{d}), e pai de
...
Assim ela é feita na aldeia \emph{Awa} (\textsc{ti} Caru) na última sessão
...
\emph{takaja}, mais recentemente, sobretudo, os Guajá da \textsc{ti} Caru --- onde
...
Proteção da \textsc{funai}. É interessante, pois a primeira tradução em português
...
recentemente, ao menos nas aldeias Awa e Tiracambu (na \textsc{ti} Caru), a ideia
...
\section{\emph{Aru karawara}, trazer os \emph{karawara}}
...
história. A desintrusão da \textsc{ti} Awá em 2013/2014 revelou uma terra
devastada; na \textsc{ti} Caru temos o mesmo quadro, porém este é agravado pelo
impacto da Estrada de Ferro Carajás (\textsc{efc}) em que duas aldeias estão
