...
\versal{FUNAI}, comer arroz e farinha. O fato de eles morarem em aldeias, e não
...
\item
  \emph{\versal{INAMẼXA'A}} -- ``gente anambé''. Um caçador de tucanos. Esse \emph{karawara}
...
\item
  \versal{\emph{KAMIXA TUWIRA}} -- ``gente jaboti''. \emph{Karawara} caçador de capelão.
  Seu \emph{nima} terreno é o \emph{jaboti}, \emph{kamixa}.
\item
  \emph{\versal{JAXAJHU JARA}} -- ``gente capininga''. Tal como o \emph{karawara} ``jaboti''
...
\item
  \versal{\emph{PAKWA'Ĩ JARA}} -- ``gente (pássaro) rolinha''. \emph{Karawara} caçador de
  capelães. Seu duplo terreno é o pássaro \emph{Pakwa'ĩa} (um tipo de
  \emph{rolinha}).
\item
  \versal{\emph{JURIXU JARA}} -- ``gente juriti''. Um caçador de capelães. Seu duplo
...
\item
  \emph{\versal{KIRIPIXA'A}} -- ``gente ubim'' (a palmeira \emph{Geonoma deversa}). É um caçador de saguis
...
\item
  \emph{\versal{HAJRA JARA}} -- ``gente papa-mel''. Trata"-se de uma versão celeste do animal
...
\item
  ...
  um sapo.
\item
  \emph{\versal{KARA PYRANA'I}} -- ``gente cará''. Ao lado da macaxeira, é o único
...
\item
  \emph{\versal{MAKAXIXA'A}} -- ``gente macaxeira''. Um \emph{karawara} caçador de porcos. Seu
...
\item
  \emph{\versal{WAHA JARA}} -- ``gente carangueijo"-do"-rio''. Um \emph{karawara} caçador de veados. Seu
  \emph{nima} terreno é o \emph{carangueijo"-do"-rio} (\emph{waha}).
\item
  \emph{\versal{IRAPA JARA}} -- ``gente pau d’arco''. É uma espécie de ``dono do arco'' celeste.
...
\item
  \emph{\versal{XXAPEJ JARA}} -- ``gente garrinchão''. Um \emph{karawara} caçador de
  macacos"-pregos. Seu \emph{nima} terreno é o pássaro \emph{txapej xoxo}
  (garrinchão"-pai"-avô, \emph{Pheugopedius genibarbis}).
\item
  \versal{\emph{HOA'Ĩ JARA}} -- ``gente coco de babaçu''. É um caçador de macacos"-pregos.
  Seu \emph{nima} terreno é o coco do \emph{babaçu}.
\item
  \versal{\emph{INAJA JARA}} -- ``gente inajá''. Um \emph{karawara} caçador
...
\item
  \emph{\versal{KAKỸ JARA}} -- ``gente gralhão''. É um \emph{karawara} muito bravo
  (\emph{imahy}) que vem à Terra matar os \emph{karaia}. Seu \emph{nima}
  terreno é o pássaro \emph{kakỹa} (\emph{gralhão}, \emph{Ibycter
  americanus}).
\item
  \emph{\versal{WIRAHO JARA}} -- ``gente harpia''. Um caçador de preguiças,
...
\item
  \emph{\versal{JAPINI'I JARA}} -- ``gente xexéu''. Tal como \emph{japu jara}, esse
...
\item
  \emph{\versal{PANY'ĨA}} -- ``gente borboleta''. Um \emph{karawara} caçador de porcos. Seu
...
\item
  \versal{\emph{HAKO JARA}} -- ``gente socó''. Um \emph{karawara} pescador, que só se
...
\item
  \versal{\emph{AKYRY JARA}} -- ``gente maçariquinho''. Um caçador de antas. Seu \emph{nima} na
  Terra é uma espécie de maçarico chamado \emph{akyry,}
  Batuíra"-de"-coleira (\emph{Charadrius collaris}).
\item
  \emph{\versal{IMYKYRIAMA JARA}} -- ``gente gaivota''. Um \emph{karawara} que só vem à
...
\item
  \emph{\versal{WIWI JARA}} -- ``gente tiriba''. Um caçador de saguis. Seu \emph{nima}
  terreno é o pássaro \emph{wiwia} (\emph{tiriba"-de"-hellmayr},
  \emph{Pyrrhura amazonum}).
\item
  \emph{\versal{MIXIRAKA'Ĩ̃}} -- ``gente inhambu-preto''. Um caçador de veados. Seu \emph{nima} na
  Terra é o pássaro \emph{mixiraka'ĩa} (\emph{inhambú"-preto},
  \emph{Crypturellus} \emph{cinereus}).
\item
  \emph{\versal{MANIMY JARA}} -- ``gente beija-flor''. Esse \emph{karawara} tem porcos como
  seus animais de criação no \emph{iwa}. Seu \emph{nima} terreno é um
  tipo de \emph{beija"-flor} chamado \emph{manimya}.
\item
  \emph{\versal{HAKURA JARA}} -- ``gente bacurau''. Um \emph{karawara} caçador de porcos. Seu
  \emph{nima} é o pássaro \emph{hakura}, \emph{bacurau}
  (\emph{Nyctidromus albicollis}).
\item
  \emph{\versal{HAKAWỸ JARA}} -- ``gente acauã''. Um \emph{karawara} que caça cobras para
...
\item
  \emph{\versal{JARITEA URU}} -- ``gente urubu-rei''. Um \emph{karawara} que nunca desce à
  Terra. Seu \emph{nima} é o \emph{urubu"-rei} (\emph{Sarcoramphus
  papa}).
\item
  \emph{\versal{MEROWỸ̃}} -- ``gente mosca''. Um caçador de macacos"-pregos, preguiças e
  papa"-mel. Seu \emph{nima} terreno são várias \emph{moscas},
  \emph{merua}.
\item
  \emph{\versal{TAKAWARI PINI}} -- ``gente taquara''. Um \emph{karawara} temido pelos
  \emph{tapỹna} do céu. Seu \emph{nima} é um tipo de taquara.
\item
  \emph{\versal{PANANỸNAWHY JARA}} -- ``gente (pássaro) Martim-Pescador''. Um \emph{karawara} pescador.
  Alimenta"-se de peixes. Seu \emph{nimá} é o pássaro
  \emph{pananỹnawhya}, \emph{martinho} (\emph{Chloroceryle
  americana}).
\item
  \versal{\emph{ARAPIJỸ JARA}} -- ``gente (pássaro) ariramba''. Um \emph{karawara} cujo
  \emph{nima} é o pássaro \emph{arapijỹa}
  (\emph{ariramba"-de"-cauda"-ruiva}, \emph{Galbula ruficauda}).
\item
  \versal{\emph{TAKANIHĨ JARA}} -- ``gente araçari''. \emph{Karawara} que desce à Terra para
...
\item
  \versal{\emph{JAMUKUNI JARA}} -- ``gente gavião''. Um caçador de nhambus e
...
\begin{itemize}
\item
  \emph{\versal{ARAKU JARA}} -- ``gente saracura''. \emph{Karawara} caçador de porcos. Vive
...
\item
  \versal{\emph{ARARAKỸ JARA}} -- ``gente araracanga''. Um \emph{karawara} que se
  alimenta exclusivamente de pequi. Seu \emph{nima} é a arara
  \emph{ararakỹa}, araracanga (\emph{Ara macao}).
\item
  \emph{\versal{JAWA KA'APARA}} -- ``gente onça''. É um \emph{karawara} onça
...
\item
  \emph{\versal{TAMANAWÃ JARA}} -- ``gente tamanduá"-bandeira''. Um \emph{karawara} que nunca desce à
...
\item
 ...
 \item
  ...
  ruficollis}).
  \item
  \emph{\versal{MA'ARAWY}} -- caçador comedor de cuxiús.
  \item
...
Proteção da \versal{FUNAI}. É interessante, pois a primeira tradução em português
