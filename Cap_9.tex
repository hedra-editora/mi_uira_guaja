...
%não indígena (brancos) & \emph{karaia} & \emph{jawarymỹ}\tabularnewline
...
%grande''\tabularnewline
%tucano/araçari & \emph{takỹna} & \emph{iratara} -- ``o que fica na
%árvore''\tabularnewline
%onça pintada & \emph{jawaruhua} & \emph{ma'amijarawỹpinĩa} - ``caça
%pintada''\tabularnewline
%gato maracajá & \emph{jawaraca'ĩa} & \emph{ma'amijarawỹpinĩa} - ``caça
%pintada''\tabularnewline
...
%paca & \emph{kararuhua} & \emph{ma'amijaperemuhũa} - ``caça
...
%\emph{irarawyxa'amỹna} - ``sangue na flecha''%

%\emph{irarawaxa'amỹna} ``o que mora na árvore''\strut
%\end{minipage}\tabularnewline
%\begin{minipage}[t]{0.30\columnwidth}\raggedright
%cuxiú-preto\strut
%\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
...
%\emph{ma'amijawykwajaxa'amỹna} - ``caça que é dona do buraco do chão''%
...
%\emph{ira'ixa'amỹna} - \emph{``}aquilo que morreu no pau''.\strut
%\end{minipage}\tabularnewline
