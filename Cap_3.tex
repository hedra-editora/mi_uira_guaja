...
\begin{tabular}{|l|}
\hline
\begin{tabular}[c]{@{}l@{}}Principais alimentos proibidos a (1) mulheres menstruadas; \\ (2) mulheres e homens em resguardo pós-nascimento\end{tabular}                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
\begin{tabular}[c]{@{}l@{}}\smallskip 1) ovos de jaboti (kamixa ripiakera)\\ \smallskip  2) ovos de jacaré (jakare ripiakera)\\ \smallskip  3) jaboti fêmea (o macho pode)\\ \smallskip 4) carne de jacaré\\ \smallskip 5) peixe surubim\\ \smallskip 6) piranha\\ \smallskip 7) peixe curimatá\\ \smallskip 8) peixe traíra\\ \smallskip 9) fígado e vísceras em geral\\ \smallskip 10) macacos adultos \\ \smallskip 11) paca\\ \smallskip 12) queixada\\ \smallskip 13) aves "galináces" como jacamin, inhambu e mutum\\ \smallskip 14) veado mateiro (arapaha)\\ \smallskip 15) veado foboca (arapaha’ia)\\ \smallskip 16) pequiá, ou pequi (Caryocar villosum) (myky'a)\\ \smallskip 17) pelo menos seis tipos de mel\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}iramuira - mel do inhambu → febre\\ \\ kamixaira - mel do jaboti → coceira no corpo\\ \\ mu'uira → atrofia nos dedos das mãos e pés\\ \\ tataira - abelha caga-fogo\\ (Oxytrigona tataira tataíra) → queima a pele da criança\\ \\ pirairuhua → causa calafrios em pais e filhos\\ \\ uhua - mel da anta/abelha "xupé" \\ (trigona hyalinata Lepeletier) → não identificado\end{tabular} \\ \hline
\end{tabular}
\end{table}
