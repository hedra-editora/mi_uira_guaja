...
\textbf{25} & \textit{Jakỹira}                            & queixada                                                                                \\ \hline
\textbf{26} & \textit{Arateiryhua (\emph{um mel azedo})}         & queixada                                                                                \\ \hline
\textbf{27} & \textit{Haipijũa (\emph{diferente do} haipjúna)}   & a rã \emph{iwẽa}                                                                               \\ \hline
\textbf{28} & \textit{Iwerikoira}                         & a rã \emph{iwẽa}                                                                               \\ \hline
\textbf{29} & \textit{Arapaha nimuira}                    & veado                                                                                   \\ \hline
\textbf{30} & \textit{Hajpea}                             & \begin{tabular}[c]{@{}l@{}}Os donos são as abelhas\\ \emph{uhú} (``abelhas antas'')\end{tabular} \\ \hline
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{animal}          & \textbf{\emph{hawaja} (afinidade)} & \textbf{Animal}                                                          \\ \hline
tatu (\emph{tatu})              &                            & \begin{tabular}[c]{@{}l@{}}paca \\ (\emph{kararuhua})\end{tabular}              \\ \hline
onça (\emph{jawara})            &                            & \begin{tabular}[c]{@{}l@{}}jaguatirica \\ (\emph{jawarata'ĩa})\end{tabular}     \\ \hline
jacamim (\emph{jacamĩa})        &                            & \begin{tabular}[c]{@{}l@{}}um tipo de inhambu\\ (\emph{iramutũna})\end{tabular} \\ \hline
jibóia (\emph{majhua})          &                            & \begin{tabular}[c]{@{}l@{}}cobra\\ (\emph{ma'arymi'ĩa})\end{tabular}            \\ \hline
jacú (\emph{jakua})             &                            & \begin{tabular}[c]{@{}l@{}}mutum \\ (\emph{miitũa})\end{tabular}                \\ \hline
jabotí (\emph{kamixa})          &                            & \begin{tabular}[c]{@{}l@{}}jabota \\ (\emph{kamixatua})\end{tabular}            \\ \hline
poraquê (\emph{manakya})        &                            & \begin{tabular}[c]{@{}l@{}}jacaré \\ (\emph{jakarea})\end{tabular}              \\ \hline
veado (\emph{arapaha})          &                            & \begin{tabular}[c]{@{}l@{}}anta \\ (\emph{tapi'ira})\end{tabular}               \\ \hline
paca (\emph{kararuhua})         &                            & \begin{tabular}[c]{@{}l@{}}cotia \\ (\emph{akwixia})\end{tabular}               \\ \hline
porco (\emph{xahoa})            &                            & \begin{tabular}[c]{@{}l@{}}caititú \\ (\emph{matỹa})\end{tabular}               \\ \hline
guariba (\emph{waria})          &                            & \begin{tabular}[c]{@{}l@{}}macaco-prego \\ (\emph{ka'ia})\end{tabular}          \\ \hline
macaco cairara (\emph{ka'ihua}) &                            & \begin{tabular}[c]{@{}l@{}}macaco-prego \\ (\emph{ka'ia})\end{tabular}          \\ \hline
macaco-cuxiú (\emph{kwixua})    &                            & \begin{tabular}[c]{@{}l@{}}macaco kairara \\ (\emph{ka'ihua})\end{tabular}      \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Possibilidades} & \textbf{Exemplos}                                                                                                                                              & \textbf{\begin{tabular}[c]{@{}l@{}}Relações \emph{riku}/criação\\ (\emph{jara}/criador→ \emph{nima}/cria)\end{tabular}}        \\ \hline
...
\textbf{c)}             & \begin{tabular}[c]{@{}l@{}}mulheres e animais\\ de criação\end{tabular}                                                                                        & \emph{awa} (humanos)→ animais                                                                                    \\ \hline
...
Zo'e, um povo linguisticamente próximo aos Guajá\footnote{Segundo
  ...
  pertencem ao sub"-grupo \versal{VIII} (oito) da família Tupi"-Guarani, o que os
