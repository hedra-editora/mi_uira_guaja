...
%4 & \emph{Hairaxĩa} & capininga (um quelônio)\tabularnewline
%5 & \emph{Akuxirua} & cotia\tabularnewline
%6 & \emph{Tataira} & cuxiú\tabularnewline
%7 & \emph{Xaĩna} & capelão\tabularnewline
...
%25 & \emph{Jakỹira} & queixada\tabularnewline
%26 & \emph{Arateiryhua} (um mel azedo) & queixada\tabularnewline
%27 & \emph{Haipijũa} (diferente do \emph{haipjúna}) & a rã
%\emph{iwẽa}\tabularnewline
%28 & \emph{Iwerikoira} & a rã \emph{iwẽa}\tabularnewline
...
%32 & \emph{Hajpiũna} & ?\tabularnewline
...
%onça (\emph{jawara}) & & jaguatirica (\emph{jawarata'ĩa})\tabularnewline
%jacamim (\emph{jacamĩa}) & & um tipo de inhambu
%(\emph{iramutũna})\tabularnewline
%jibóia (\emph{majhua}) & & cobra (\emph{ma'arymi'ĩa} )\tabularnewline
%jacú (\emph{jakua}) & & mutum (\emph{miitũa})\tabularnewline
...
%porco (\emph{xahoa}) & & caititu (\emph{matỹa})\tabularnewline
...
%\textbf{h)} & \emph{ajỹa} e macaco-da-noite & ogros não humanos →
%animais\tabularnewline
