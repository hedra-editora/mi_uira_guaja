...
\begin{tabular}{|l|l|l|}
\hline
\textbf{animal}                                                    & \textbf{\begin{tabular}[c]{@{}l@{}}\emph{hawaja}\\ (afinidade)\end{tabular}} & \textbf{Animal}                                                          \\ \hline
...
\begin{tabular}[c]{@{}l@{}}jacamim \\ (\emph{jacamĩa})\end{tabular}       &                                                                      & \begin{tabular}[c]{@{}l@{}}um tipo de inhambu\\ (\emph{iramutũna})\end{tabular} \\ \hline
\begin{tabular}[c]{@{}l@{}}jibóia \\ (\emph{majhua})\end{tabular}         &                                                                      & \begin{tabular}[c]{@{}l@{}}cobra \\ (\emph{ma'arymi'ĩa})\end{tabular}            \\ \hline
jacú (\emph{jakua})                                                       &                                                                      & mutum (\emph{miitũa})                                                           \\ \hline
\begin{tabular}[c]{@{}l@{}}jabotí \\ (\emph{kamixa})\end{tabular}         &                                                                      & \begin{tabular}[c]{@{}l@{}}jabota \\ (\emph{kamixatua})\end{tabular}            \\ \hline
\begin{tabular}[c]{@{}l@{}}poraquê\\ (\emph{manakya})\end{tabular}        &                                                                      & \begin{tabular}[c]{@{}l@{}}jacaré\\ (\emph{jakarea})\end{tabular}               \\ \hline
veado (\emph{arapaha})                                                    &                                                                      & anta (\emph{tapi'ira})                                                          \\ \hline
paca (\emph{kararuhua})                                                   &                                                                      & cotia (\emph{akwixia})                                                          \\ \hline
porco (\emph{xahoa})                                                      &                                                                      & caititú (\emph{matỹa})                                                          \\ \hline
guariba (\emph{waria})                                                    &                                                                      & \begin{tabular}[c]{@{}l@{}}macaco-prego\\ (\emph{ka'ia})\end{tabular}           \\ \hline
\begin{tabular}[c]{@{}l@{}}macaco cairara\\ (\emph{ka'ihua})\end{tabular} &                                                                      & \begin{tabular}[c]{@{}l@{}}macaco-prego\\ (\emph{ka'ia})\end{tabular}           \\ \hline
\begin{tabular}[c]{@{}l@{}}macaco-cuxiú\\ (\emph{kwixua})\end{tabular}    &                                                                      & \begin{tabular}[c]{@{}l@{}}macaco kairara\\ (\emph{ka'ihua})\end{tabular}       \\ \hline
\end{tabular}
\end{table}
