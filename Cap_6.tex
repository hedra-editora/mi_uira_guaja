...
tatu (tatu)                           & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}paca \\ (kararuhua)\end{tabular}              \\ \hline
onça (jawara)                         & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}jaguatirica \\ (jawarata'ĩa)\end{tabular}     \\ \hline
jacamim (jacamĩa)                     & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}um tipo de inhambu\\ (iramutũna)\end{tabular} \\ \hline
jibóia (majhua)                       & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}cobra \\ (ma'arymi'ĩa)\end{tabular}           \\ \hline
jacú (jakua)                          & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & mutum (miitũa)                                                           \\ \hline
jaboti (kamixa)                       & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}jabota \\ (kamixatua)\end{tabular}            \\ \hline
poraquê (manakya)                     & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}jacaré \\ (jakarea)\end{tabular}              \\ \hline
veado (arapaha)                       & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & anta (tapi'ira)                                                          \\ \hline
paca (kararuhua)                      & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & cotia (akwixia)                                                          \\ \hline
porco (xahoa)                         & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & caititu (matỹa)                                                          \\ \hline
capelão (waria)                       & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}macaco-prego \\ (ka'ia)\end{tabular}          \\ \hline
macaco cairara (ka'ihua)              & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}macaco-prego \\ (ka'ia)\end{tabular}          \\ \hline
macaco-cuxiú (kwixua)                 & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}macaco kairara \\ (ka'ihua)\end{tabular}      \\ \hline
\end{tabular}
\end{table}
...
babaçu (wã'y)          & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular} & inajá (inajá)         \\ \hline
tucum (tacamã)         & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular} & palmeira marajá (yúa) \\ \hline
bacaba (pinõwa)        & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular} & açaí (yahara)         \\ \hline
bacuri (mukuri)        & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular} & pequi (piquiá)        \\ \hline
cacau selvagem (ako'o) & \begin{tabular}[c]{@{}c@{}}←\\ →\end{tabular} & cupuaçu (kipu)        \\ \hline
\end{tabular}
\end{table}
