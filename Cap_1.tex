...
1988 apud Balée 1992), cientistas com diferentes orientações, como se
...
(\versal{MA}), Marabá (\versal{PA}) e Paraupebas (\versal{PA}), desde o ano de 1767. E na região da
...
Tupi"-Guarani'' desde o século \versal{XVII} (Nimuendajú, 1948, apud Viveiros de
...
levou cerca de 6,7 indígenas para o então \versal{PI} Gonçalves Dias (em parte
onde hoje é a \versal{TI} Rio Pindaré), e todas morreram em alguns meses (idem).
...
\begin{quote}
A pressão feita pela sociedade envolvente nesta região com infiltrações
...
Ajura e Juriximaty᷉a que vivem na aldeia Juriti (\versal{TI} Awá).
...
Kamairua veio do Awá e foi para onde estávamos com meu pai, o Muturuhu᷉.
Ele encontrou o Muturuhu᷉ primeiro. E então o Muturuhu᷉ disse que havia
...
``branco bom'' (karai katy). (\ldots{}) Ele ia nos levar para lá (\versal{PIN} Awá)
...
\begin{quote}
As roças normalmente exigem um ciclo de atividades que tem que ser
