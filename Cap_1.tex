...
por funcionários da \versal{FUNAI} a cultivar mandioca (basicamente para a
...
``características do Paleolítico'' em pleno século \versal{XX} (Hill \& Hawkes,
...
mesmo território há décadas ---, os Guajá e Guajajara da \versal{TI} Caru procuram
estabelecer alianças políticas, principalmente frente às reivindicações
dirigidas à \versal{FUNAI}/\versal{SESAI}. No entanto, ao mesmo tempo algumas pessoas das
...
Terra Indígena (\versal{TI}) Caru, com 172.600 ha ocupados conjuntamente com os
...
Awá, na \versal{TI} Caru), algo que os Guajá não conheciam em sua história
...
\versal{SESAI}, \versal{FUNAI}, Vale ou demandas mais abrangentes ligadas aos indígenas.
...
Indígenas (\versal{TI}) Caru e Awá (no estado do Maranhão). O tal contato, melhor
...
utilizado para caçadas de todo tipo pela aldeia conhecida como Awá (\versal{TI}
Caru).

De acordo com a \versal{FUNAI}, tal como foi noticiado em portais de associações
como o Conselho Indigenista Missionário (\versal{CIMI} 2015) e outros sites de
...
Frente de Proteção Etnoambiental Awá-Guajá (\versal{FPEAG}), da mesma forma que
...
levou cerca de 6, 7 indígenas para o entã̃o \versal{PI} Gonçalves Dias (em parte
onde hoje é a \versal{TI} Rio Pindaré), e todas morreram em alguns meses (\emph{idem}).
...
se encontra na documentação do \versal{SPI}/\versal{FUNAI} muitos relatos sobre pequenos
...
contatado anos antes e alocado na aldeia Awá (\versal{TI} Caru), e os de
...
lembra inclusive de Mércio Gomes (antropólogo --- e ex"-presidente da \versal{FUNAI}
...
Segundo estimativas de alguns funcionários da \versal{FUNAI}, os Guajá não têm um
...
sempre com a ajuda de mão de obra contratada pela \versal{FUNAI} ---, ainda não
