...
``características do Paleolítico'' em pleno século XX (Hill \& Hawkes
...
Indígenas (TI) Caru e Awá (no estado do Maranhão). O tal contato, melhor
...
utilizado para caçadas de todo tipo pela aldeia conhecida como Awá (TI
Caru).

De acordo com a FUNAI, tal como foi noticiado em portais de associações
como o Conselho Indigenista Missionário (CIMI 2015) e outros sites de
...
Frente de Proteção Etnoambiental Awá-Guajá (FPEAG), da mesma forma que
...
levou cerca de 6,7 indígenas para o então PI Gonçalves Dias (em parte
onde hoje é a TI Rio Pindaré), e todas morreram em alguns meses (idem).
...
se encontra na documentação do SPI/FUNAI muitos relatos sobre pequenos
...
\section{\emph{Wytyra}, as terras altas (foto aérea de Sebastião
Salgado)}
...
\begin{quote}
\emph{" (...) E estávamos fugindo dos karai (não-índígenas) e não
...
\begin{quote}
\emph{``(...) Comíamos só jaboti. Estávamos eu, minha mãe, meu pai,
...
tivemos que nos espalhar. (...) Queríamos vir para cá (para o Posto
...
``branco bom'' (karai katy). (...) Ele ia nos levar para lá (PIN Awá)
...
Segundo estimativas de alguns funcionários da FUNAI, os Guajá não têm um
...
sempre com a ajuda de mão de obra contratada pela FUNAI -, ainda não
