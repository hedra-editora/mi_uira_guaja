...
propiciado pela \textsc{sucam}). Em linhas gerais, a \textsc{sucam} é \emph{jara} das
baratas. Segundo Wirahoa, ``a \textsc{funai} foi a responsável por trazer as
baratas até a aldeia'', porém, por não ser um \emph{jara} das baratas, a
\textsc{funai} teve que chamar o verdadeiro ``dono'' delas, a \textsc{sucam}, ela sim, por
...
trata o \emph{riku}. É esta a relação entre a \textsc{sucam} e as baratas, uma
relação de \emph{criação}.

Ainda dentro da categoria ``pragas'', assim como a \textsc{sucam} é \emph{jara}
...
\paragraph{Exemplo 2. Donos de nome (2ª parte)}
...
\paragraph{Exemplo 3. Donos, duplos}
...
\emph{jara} de seu duplo terrestre, um \emph{nima}, tendo"-se em vista o
fato de, para os Guajá, tais categorias serem subordinadas à posição que
ocupam os seres.

\paragraph{Exemplo 4. \emph{Haira}, o mel}
...
Ofaié, \textsc{m}192, citado por Lévi"-Strauss, \emph{op. cit.}), os Guajá defendem, ao
...
de mel, além de serem atestadas por diferentes mitologias\footnote{O
  referido mito ofaié, utilizado por Lévi"-Strauss (\textsc{m}192), embora tenha
...
\paragraph{Exemplo 5. \emph{Karawara}}
...
de ``superdonos'', os \emph{karawara} parecem ser, de alguma maneira,
...
caça, nos capítulos 6 e 7, voltarei a discutir os \emph{karawara}. Por
...
\emph{hawaja} por excelência são \textsc{zs} e \textsc{mb}), e os Guajá defendem que tal
...
\paragraph{\emph{Wari Jara}: sobre a origem das relações de gênero}
...
um jovem ribeirinho chamado Chico,\footnote{Chico do Cajú, que nasceu às
  ...
  É contratado da \textsc{funai} para ajudar em tarefas pesadas do Posto
