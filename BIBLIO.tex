...
Philppe \& Gislí Palson. México: Siglo \textsc{xxi}.
...
ecologia cultural na Amazônia}, trabalho lido no Simpósio \textsc{aba}/\textsc{anpocs}.\\
...
of Illinois at Urbana"-Champaign, Ann Arbor \textsc{umi}, Inc.
...
Calheiros, Orlando.\\
\textbf{2014}. \emph{Aikewara: Esboços de uma sociocosmologia tupi"-guarani}. Tese de Doutorado. Rio de Janeiro: Museu Nacional/\textsc{ufrj}.
...
Cesarino, Pedro.\\
\textbf{2008}. \emph{\textsc{oniska}: A poética da morte e do mundo entre os
...
\textsc{cimi} -- Conselho Indigenista Missionário.\\
...
Anthropological Institute} (\textsc{n.s.}), 13:527--544
...
Dooley, Robert A.\\
\textbf{1982}. \emph{Vocabulário do Guarani}. Brasília, \textsc{df}: Summer
...
Ameríndios}. Viveiros de Castro, eduardo (org). Rio de Janeiro: Editora~\textsc{ufrj}.\\
\textbf{2001}. \emph{Inimigos fiéis: história, guerra e xamanismo na
Amazônia}. São Paulo: \textsc{edusp}.\\
...
Laraia, Roque.\\
\textbf{1986}. \emph{Tupi: Índios do Brasil Atual}. São Paulo, \textsc{fflch},
...
Rosalen, Juliana.\\
\textbf{2005}. Aproximação à temática das \textsc{dst} junto aos Wajãpi do
...
\textbf{2011}. ``What kinship is (part one)''. \textsc{jrai} (\textsc{ns}), 17:2--19;
...
\textbf{1980}. \emph{Parecer sobre o processo Funai/ \textsc{bsb}/ 5044/ 79,
...
\textbf{1980}. Centro Ecumênico de Documentação e Informação (\textsc{cedi}) --
...
\textbf{1982}. \emph{Resposta ao Del. da 6ª \textsc{dr}"-Funai com acusações em
...
\textbf{1985}. Funai/\textsc{cvrd} -- \emph{Relatório sobre os índios Guajá
...
\textbf{1985}. Funai/\textsc{cvrd} -- \emph{Programa Awá -- relatório Inicial}.
Mércio Pereira Gomes.

\textbf{1985}. Funai/\textsc{cvrd} -- \emph{Relatório antropológico sobre a área
indígena Guajá (Awá-Gurupi)}. Mércio Pereira Gomes.

\textbf{1985}. Funai/ \textsc{cvrd} -- \emph{Área indígena Awá-Gurupi. Estudos e
proposta.} José Carlos Meirelles Júnior e Mércio Pereira Gomes.

\textbf{1985}. \textsc{cvrd} -- \emph{Nota para a imprensa.}

\textbf{1987}. Funai -- \emph{Parecer nº 171/87 -- \textsc{gt}.Interministerial
...
\textbf{1987}. \textsc{cimi} -- \emph{Parecer sobre os Awá} . Paulo Mahado
Guimarães.

\textbf{1987}. \textsc{suer}/ \textsc{spag} -- Convênio Funai/\textsc{cvrd}. \emph{Relatório de
...
\textbf{1987}. \textsc{cedi} -- \emph{Campanha Guajá}.

\textbf{1988}. Funai -- \emph{Parecer nº 197/88 -- \textsc{gt} Interministerial
...
\textbf{1988}. Funai -- \emph{Relatório de viagem às \textsc{adr}'s do Estado do
...
\textbf{1989}. Funai -- \emph{Relatório sobre aspectos gerais do \textsc{pin}
...
\textbf{1990}. Funai -- \emph{Apresentação de relatório, \textsc{pin} Guajá}.
Egipson Nunes Correia.

\textbf{1990}. Convênio \textsc{cvrd} -- Funai. Missão do Banco Mundial -- \textsc{papp}/
...
\textbf{2013}. Funai -- Relatório sobre viagem para a \textsc{ti} Awá. Felipe V.M.
Almeida.
