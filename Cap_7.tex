...
\addcontentsline{toc}{part}{Andar Junto}
...
mesmo \emph{trabalhar} com a \versal{FUNAI} são atividades passíveis de ser
...
da \versal{FUNAI} (inclusive com o auxílio de linhas, anzóis e tarrafas
...
pela \versal{FUNAI}. Em um período de quatro horas e em um raio de cinco metros
...
Por isso, há uma grande dificuldade por parte dos funcionários da \versal{FUNAI}
...
em situações de tradução como nas reuniões com a \versal{FUNAI} ou \versal{SESAI}, muitas
...
com algum funcionário do \versal{PIN} um cachorro malhado (\emph{peperemuhũ} --
...
cachorros que lhe foram dados por Almir (um agente de saúde da \versal{SESAI}).
...
e o enterramos. Fizeram como os \emph{karaia} da \versal{FUNAI} lhe ensinaram a
...
funcionários da \versal{FUNAI}\footnote{Os Guajá lembram até hoje de outro quati
...
Juriti certa vez me declarou: ``A primeira coisa que a \versal{FUNAI} fazia quando
...
hoje, findada a condição de ``isolados'', a \versal{FUNAI} quase não tem recursos
...
Ka'i ry'ỹa                        & Ponta do macaco-prego                                                                         \\ \hline
...
\versal{FUNAI} aplica desde a Lei Nº 10.826 de 2003 quando se instituiu o Sistema
...
representante da \versal{FUNAI} argumentou que as armas, além de tudo, eram
...
em particular, da \versal{FUNAI}. Todos conseguem relembrar a chegada das
...
dependentes da caça com armas de fogo, e a mesma \versal{FUNAI} que lhes
...
relação à \versal{FUNAI} para a compra de munição e o reparo das espingardas
...
Guajá ou dos próprios funcionários da \versal{FUNAI} (no caso do reparo de
espingardas, funcionários chegavam a me pedir ajuda, pois a
administração da \versal{FUNAI} dificilmente paga reparos). Com suas espingardas
...
regulam e não a fornecem na quantidade adequada\footnote{Só para termos
  ...
  todas as aldeias, quando solicitei autorização de pesquisa à \versal{FUNAI}. Em
  2007, ao chegar pela primeira vez na aldeia Juriti, por ter comprado a
  munição na companhia de um funcionário da \versal{FUNAI} ele pediu"-me que a
