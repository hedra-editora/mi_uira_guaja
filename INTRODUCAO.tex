\chapter*{Introdução\smallskip\subtitulo{Caminhando com os Guajá}}
\addcontentsline{toc}{chapter}{Introdução, \textit{por Uirá Garcia}}
\markboth{introdução}{}
...
Se historicamente esses dois conjuntos
...
\section{awa: parentesco, caça e cosmologia}
...
O quinto capítulo faz uma descrição do sistema de aliança, com
...
Um ponto importante é que, embora tenha mencionado as aldeias
...
quase --- como observações de campo.\footnote{Nas palavras de Marcio
  ...
  grande de coisas.'' (Goldman, 2006, p.\,170).} %Da mesma forma eu encaro este livro.

Os \textit{Caçadores, cantores, andarilhos}, o \textit{povo do
