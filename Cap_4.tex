...
\begin{center}
\versal{F} = \emph{\textbf{tu}} \emph{→} \versal{FB} = \emph{\textbf{tu-nã}}\medskip

\versal{M} = \emph{\textbf{ihí} →} \versal{MZ} = \emph{\textbf{ihi-nã}}
\end{center}
...
colaterais (\versal{FB} e \versal{MZ}) ganham o tecnônimo -\emph{kî} marcando essa
diferença, assim \versal{F} = \emph{yimî} e \versal{FB} = \emph{yimkî}. Trata"-se aqui ``do
...
entre si até a época do contato entre a \versal{FUNAI} e o grupo de Panaxĩa, em
...
Awapahara} (aqueles que vivem na aldeia do \versal{PIN} Awá), \emph{a'e rawỹ awa}
...
pela Funai, e sim pelos próprios Guajá da \versal{TI} Caru, quando trouxeram para
...
novamente e vive na aldeia do \versal{PIN} Awá. Sobre a família de Takwarẽxa'a, a
...
dividida pela sede do \versal{PIN}. As poucas vezes em que Takwarẽxa'a visita a
...
nos postos da \versal{FUNAI}, vários dos animais consumidos por Takwarẽxa'a (como
...
irmãos para ``viverem juntos'' (\emph{ikwẽ pyry}) na aldeia do \versal{PIN} Juriti,
logo que a mãe dos meninos faleceu\footnote{Wirahoa e seus irmãos
  ...
  qualquer cognato das gerações de Ego (G0), \versal{G}+1 e \versal{G}-1, que abrange
...
coco'' (Ribeiro, op. cit., p. 373). Durante todo o século \versal{XX}, nas bacias
...
\emph{Tenetehara} nos bloqueios da \versal{E}.\versal{F}.Carajás, na altura de Alto Alegre
