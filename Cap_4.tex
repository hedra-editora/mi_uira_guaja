...
\hypertarget{humanidades}{%
\section{\texorpdfstring{\textbf{Humanidades
}}{Humanidades }}\label{humanidades}}

\hypertarget{distuxe2ncias}{%
\subsection{\texorpdfstring{\textbf{Distâncias
}}{Distâncias }}\label{distuxe2ncias}}
...
F = \emph{\textbf{tu}} \emph{→} FB = \emph{\textbf{tu-nã}}

M = \emph{\textbf{ihí} →} MZ = \emph{\textbf{ihi-nã}}

Assim, ambos os sexos reconhecem o pai (F) como \emph{tu} e o irmão do
...
\begin{quote}
\includegraphics[width=2.60109in,height=3.67586in]{media/image1.png}
\end{quote}
...
\hypertarget{das-formas-de-existuxeancia}{%
\subsection{\texorpdfstring{\textbf{Das formas de existência
}}{Das formas de existência }}\label{das-formas-de-existuxeancia}}
...
\hypertarget{comida}{%
\subsection{\texorpdfstring{\textbf{Comida}}{Comida}}\label{comida}}
...
\hypertarget{amuxf5-awa-os-outros}{%
\subsection{\texorpdfstring{\textbf{\emph{Amõ Awa}, os
outros}}{Amõ Awa, os outros}}\label{amuxf5-awa-os-outros}}
...
pertencem à mesma parcialidade de ego (...). A determinação central da
...
\textbf{\emph{Mihua}, a gente do mato}
...
(...) mantêm uma variedade de relações" (Gow, 1997, p. 56), inimigos
...
\hypertarget{a-famuxedlia-de-takwarexaa}{%
\subsection{\texorpdfstring{\textbf{A família de
Takwarẽxa'a}}{A família de Takwarẽxa'a}}\label{a-famuxedlia-de-takwarexaa}}
...
\hypertarget{kamara-e-tenetehara}{%
\subsection{\texorpdfstring{\textbf{Kamara e
Tenetehara}}{Kamara e Tenetehara}}\label{kamara-e-tenetehara}}
...
indignado e, na manhã seguinte, partiu à procura dos guajajás. (...)
...
(...) Anakãpuku voltou para casa, jurando vingar-se. No ano seguinte,
...
com várias pegadas, de homens, mulheres e crianças. (...) (após seguirem
...
porém, retesou o arco e atirou e... o velho guajajá morreu flechado em
...
lanterna; dormiam poucas horas durante o dia... tudo para evitar que os
