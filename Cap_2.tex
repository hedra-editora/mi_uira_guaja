...
\addcontentsline{toc}{part}{Habitar}
...
\versal{FUNAI} (que dispõe de bens e serviços) quanto ao maior conforto oferecido
...
pomares coordenadas pela equipe da \versal{FUNAI}, seu inverno é passado entre a
...
trilhas, pois até o contato não conheciam canoas\footnote{Desde o
  contato com a \versal{FUNAI} uma geração mais jovem, que cresceu perto dos
...
contato, quando a \versal{FUNAI} passou a comprá"-las e oferecê"-las às
...
não"-indígenas\footnote{Desta forma os igarapés ``Juriti'', ``Mão de Onça'',
  ...
  ``Mão de Onça'' conhecido pela \versal{FUNAI}, o que causa certa confusão no
...
recente área indígena Awá\footnote{Os funcionários do posto se
  ...
  da \versal{FUNAI}. E, de forma muito perspicaz, os Guajá entenderam que a
...
\forceindent Em meados dos anos 1970, durante o chamado ``tempo do mato'' (\emph{imỹna
ka'ape}), antes do contato com a \versal{FUNAI}, um indivíduo chamado Akamatỹ,
...
Além das onças e dos \emph{ajỹ}, os anos tornaram inevitáveis os
...
É também o caso de Jakarexĩ que, tal como ocorreu a Karapiru, teve seu
...
Lastimo não ter conhecido pessoalmente Xaparamuhũ, e com Jakarexĩ falei
...
(\emph{tarymỹ}), tal como os Guajá, que aprenderam com a \versal{FUNAI}.
